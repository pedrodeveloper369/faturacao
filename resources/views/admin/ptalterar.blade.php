            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{url('/dashboard/Pts/update')}}" method="Post" novalidate="novalidate">
                                    @csrf
                                    {{ method_field('PUT') }}
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-12">
                                            <label for="local" class="control-label mb-1">Localização</label>
                                            <div class="input-group">
                                                <input id="local" name="localizacao" value="{{$p->localizacao}}" type="text" class="form-control"  required>
