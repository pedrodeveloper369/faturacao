                        ...
                        <div class="card">
                            <div class="card-body">
                                @php
                                  ...
                                  $id=$contrat[0]->id;
                                    @endphp
                                <form action="{{url("/dashboard/contratos/update")}}" method="post" novalidate="novalidate">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="valor_alt" class="control-label mb-1">Valor</label>
                                                <input id="valor_alt" name="valor_alt" type="text" class="form-control cc-exp" value="{{number_format( $contrat[0]->precocontrato, 2,",",".")}}" required>
